...
<ResponseField name="data" type="object" optional>
  ...
  <Expandable title="data properties">
    <ResponseField name="results" type="array">
      All results combined (successful first, then failed)

      Array of all scraped URLs with standardized format. Successful results appear first, followed by failed results.
    </ResponseField>

    <ResponseField name="successful" type="array">
      Only successful scraping results

      Filtered array containing only URLs that were successfully scraped. Each result includes:
      <Expandable title="successful result properties">
        ...
        <ResponseField name="metadata" type="object">
          ...
          <Expandable title="metadata properties">
            ...
            <ResponseField name="loadTime" type="number" optional>
    ...
    <ResponseField name="failed" type="array">
      Only failed scraping results

      Filtered array containing only URLs that failed to scrape. Each result includes:
      <Expandable title="failed result properties">
        <ResponseField name="url" type="string">
    ...
    <ResponseField name="summary" type="object">
      ...
      Comprehensive statistics about the entire batch processing job:
      <Expandable title="summary properties">
        ...
        <ResponseField name="successRate" type="number">
          ...
          **Example**: 80 (meaning 80% success rate)
        </ResponseField>
        <ResponseField name="processingTime" type="number">
          Total processing time in milliseconds
        </ResponseField>
        <ResponseField name="averageTimePerUrl" type="number">
        ...
        <ResponseField name="creditsPerUrl" type="number">
...
<ResponseExample>
```json Direct Processing Response
{
  "success": true,
  "data": {
    "results": [
