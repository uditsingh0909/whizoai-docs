...
import ScrapeAdvancedPython from "/snippets/v1/scrape/advanced/python.mdx";
import ScrapeAdvancedJS from "/snippets/v1/scrape/advanced/javascript.mdx";
import ScrapeAdvancedCurl from "/snippets/v1/scrape/advanced/curl.mdx";
import AuthSnippet from "/snippets/v1/common/authentication.mdx";
import ErrorHandling from "/snippets/v1/common/error-handling.mdx";
  ...
  <Expandable title="data properties">
    ...
    <ResponseField name="metadata" type="object">
      <Expandable title="metadata properties">
        ...
        <ResponseField name="parserName" type="string">
          Parser that extracted the content (matches engine name)
        </ResponseField>
        <ResponseField name="contentSource" type="string">
        ...
        <ResponseField name="robots" type="string">
        ...
        <ResponseField name="og" type="object">
          Open Graph protocol metadata for social sharing
          <Expandable title="Open Graph properties">
            <ResponseField name="title" type="string">
              OG title (`og:title`)
            </ResponseField>
            <ResponseField name="description" type="string">
        ...
        <ResponseField name="twitter" type="object">
          ...
          <Expandable title="Twitter Card properties">
        ...
        <ResponseField name="article" type="object">
          ...
          <Expandable title="Article metadata properties">
            ...
            <ResponseField name="tags" type="array">
              Article tags array (`article:tag`)
            </ResponseField>
          </Expandable>
        </ResponseField>

        <ResponseField name="structuredData" type="object">
          Structured data extraction (Schema.org, JSON-LD, Microdata, RDFa)
          <Expandable title="Structured data properties">
            <ResponseField name="jsonLd" type="array">
              JSON-LD structured data blocks
            </ResponseField>
            <ResponseField name="microdata" type="array">
              Microdata items extracted from HTML
            </ResponseField>
            <ResponseField name="rdfa" type="array">
              RDFa structured data
            </ResponseField>
            <ResponseField name="openGraph" type="object">
              Open Graph structured data
            </ResponseField>
            <ResponseField name="schemaTypes" type="array">
              Detected Schema.org types: Product, Recipe, Event, Review, FAQ, Article, Organization, Person, Video, Breadcrumb, Course, JobPosting, LocalBusiness, SoftwareApplication
            </ResponseField>
          </Expandable>
        </ResponseField>

        <ResponseField name="contentQuality" type="object">
          Content quality and readability metrics (29 comprehensive metrics)
          <Expandable title="Content quality metrics">
            <ResponseField name="wordCount" type="number">
              Total word count
            </ResponseField>
            <ResponseField name="sentenceCount" type="number">
              Total number of sentences
            </ResponseField>
            <ResponseField name="characterCount" type="number">
              Total character count
            </ResponseField>
            <ResponseField name="readabilityScore" type="number">
              Flesch Reading Ease score (0-100, higher = easier)
            </ResponseField>
            <ResponseField name="fleschKincaidGrade" type="number">
              Flesch-Kincaid grade level
            </ResponseField>
            <ResponseField name="averageSentenceLength" type="number">
              Average characters per sentence
            </ResponseField>
            <ResponseField name="averageWordsPerSentence" type="number">
              Average words per sentence
            </ResponseField>
            <ResponseField name="contentDensity" type="number">
              Ratio of text content to total page content (0-1)
            </ResponseField>
            <ResponseField name="estimatedReadingTimeMinutes" type="number">
              Estimated time to read (based on 200 words/minute)
            </ResponseField>
            <ResponseField name="isContentRich" type="boolean">
              Whether content exceeds quality thresholds
            </ResponseField>
            <ResponseField name="headingCount" type="number">
              Total number of headings (h1-h6)
            </ResponseField>
            <ResponseField name="paragraphCount" type="number">
            ...
            <ResponseField name="listCount" type="number">
              Number of lists (ul, ol)
            </ResponseField>
            <ResponseField name="tableCount" type="number">
              Number of tables
            </ResponseField>
            <ResponseField name="quoteCount" type="number">
              Number of blockquotes
            </ResponseField>
            <ResponseField name="codeBlockCount" type="number">
              Number of code blocks
            </ResponseField>
            <ResponseField name="contentType" type="string">
              Detected content type: article, blog, documentation, product, etc.
            </ResponseField>
            <ResponseField name="readingLevel" type="string">
              Reading difficulty: low, medium, high
            </ResponseField>
            <ResponseField name="lexicalDiversity" type="number">
              Unique words / total words ratio (0-1)
            </ResponseField>
            <ResponseField name="headingDistribution" type="object">
              Distribution of heading levels (h1-h6 counts)
            </ResponseField>
          </Expandable>
        </ResponseField>
        ...
        <ResponseField name="characterCount" type="number">
          Main content character count
        </ResponseField>
        <ResponseField name="linksCount" type="number">
          Number of extracted links
        </ResponseField>
        <ResponseField name="imagesCount" type="number">
...
const data = await response.json();
console.log('Metadata fields:', Object.keys(data.data.metadata).length);
```
...
data = response.json()
print(f"Extracted {len(data['data']['metadata'])} metadata fields")
```

</CodeGroup>

<ResponseExample>
```json Comprehensive Metadata Response
{
  "success": true,
  "data": {
