...
```json
{
  ...
  "data": {
    ...
    "initialSnapshot": {
      ...
      "screenshotUrl": "https://storage.whizoai.com/screenshots/mon_abc123_initial.png"
    }
  }
}
```
    ...
    "recentChanges": [
      {
        ...
        "beforeScreenshot": "https://storage.whizoai.com/screenshots/before_xyz789.png",
        "afterScreenshot": "https://storage.whizoai.com/screenshots/after_xyz789.png",
        "diff": {
          "added": 156,
          "removed": 89,
          "modified": 23
    ...
    "changes": [
      {
        ...
        "afterHash": "def456",
        "screenshots": {
          "before": "https://storage.whizoai.com/screenshots/before_xyz789.png",
          "after": "https://storage.whizoai.com/screenshots/after_xyz789.png",
          "diff": "https://storage.whizoai.com/screenshots/diff_xyz789.png"
        },
        "diff": {
          "format": "unified",
          "added": 156,
...
const monitorResponse = await fetch('https://api.whizoai.com/v1/monitor', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
...
// Check for changes
const changesResponse = await fetch(`https://api.whizoai.com/v1/monitor/${monitor.data.monitor.id}/changes`, {
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
  }
});
...
response = requests.post(
    'https://api.whizoai.com/v1/monitor',
    headers={
        'Authorization': 'Bearer YOUR_API_KEY',
        'Content-Type': 'application/json'
    },
...
changes_response = requests.get(
    f'https://api.whizoai.com/v1/monitor/{monitor_id}/changes',
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://api.whizoai.com/v1/monitor/batch');
...
```bash cURL
# Create a monitor
curl -X POST "https://api.whizoai.com/v1/monitor" \
...
# List all monitors
curl -X GET "https://api.whizoai.com/v1/monitor?status=active&limit=50" \
  -H "Authorization: Bearer YOUR_API_KEY"

# Get monitor changes
curl -X GET "https://api.whizoai.com/v1/monitor/mon_abc123/changes?include_diff=true" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```json
{
  ...
  "screenshots": {
    "before": "https://storage.whizoai.com/before.png",
    "after": "https://storage.whizoai.com/after.png",
    "diff": "https://storage.whizoai.com/diff.png"
  }
}
```
